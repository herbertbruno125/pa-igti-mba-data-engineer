...
__write_name = f'bf-flmla-csldo-{datetime.date.today()}.csv'
write_key = f'insight/bf-states/process_date={datetime.date.today()}/{__write_name}'
...
def lambda_handler(event, context):
    file = s3_client.get_object(Bucket='dcb-raw-zone', Key=f'ibge/bolsa-familia/bs-flmla-{reference_month}.json')
